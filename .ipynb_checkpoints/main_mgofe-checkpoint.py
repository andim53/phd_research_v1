...
kappa=2 # for LCB acquisition
N_iterations = 100

mgo_layer_number = 1
fe_layer_number = 1
confinement_cell_height_multiplyer = 4 # increase top cell
...
0: [20, 0]
From 0th iteration, it produce 20 candidate for 1st Generator (small-scale rattle), and 0 candidate for the 2nd genedator (large-scale rattle)

10: [10, 10]
From the 10th iteration, it produce 10 candidate for small-scale, and 10 for wide-scale.
"""
num_candidates={0:[20,0], 10:[10,10], 25:[0,20]} # Iteration control; 0:[20,0]
sample_size = 20
...
"""
symbol_add = 'B'
z_height_add = 0 # 0 A -> place the same position, in z axis, with substrate
num_atoms_add = 2
